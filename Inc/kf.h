...
/* Matrix Sizes */
	...
	#define NUMBER_STATES 10	/* NUMBER_STATES x NUMBER_STATES -> A Matrix */
	#define NUMBER_INPUTS 7	/* NUMBER_STATES x NUMBER_INPUTS -> B Matrix */
	#define NUMBER_PROCESS_NOISE 7	/* NUMBER_STATES x NUMBER_PROCESS_NOISE -> G Matrix */
#endif
